...
export class KarigarAddComponent implements OnInit {
    ...
    selectSales()
    {
        ...
        this.karigarform.branch_manager = this.sales_users.filter( x => x.id === this.karigarform.sales_user )[0].branch_manager;
        this.karigarform.branch_head = this.sales_users.filter( x => x.id === this.karigarform.sales_user )[0].branch_head;
